...
namespace DigitalRuby.PyroParticles
{
    ...
    public class FireBaseScript : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            CreateExplosionNonStatic(gameObject.transform.position, ForceRadius, ForceAmount);
        ...
        public static void CreateExplosion(Vector3 pos, float radius, float force)
        {
            ...
            //Ability.AbilityTypeFireExplosionImpact(Caster, objects);
        ...
        public void CreateExplosionNonStatic(Vector3 pos, float radius, float force)
        {
            if (force <= 0.0f || radius <= 0.0f)
            {
                return;
            ...
            if (Ability.Type == AbilityType.FireExplosion)
            {
                Ability.AbilityTypeFireExplosionImpact(Caster, objects);
            }
